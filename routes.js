var main = require('./controller/main.js'),
	contest = require('./controller/contest.js'),
	vacation = require('./controller/vacation.js'),
	cart = require('./controller/cart.js'),
	// cartValidation = require('./lib/cartValidation.js');
	contact = require('./controller/contact.js'),
	samples = require('./controller/sample.js');
...
module.exports = function(app){
	...
	// app.get('/vacations/update', vacation.add);
